...
extern "C"
__global__
void add_kernel(const float *A, const float *B, float *C, int size) {
...
print("compile used time: ", toc2 - toc)
input1 = torch.randn(4 * 256, device="cuda")
input2 = torch.randn(4 * 256, device="cuda")
M = 4
output = torch.empty(4 * 256, device="cuda")
kernel((M,1,1), (256,1,1), (input1, input2, output, input1.numel()))
